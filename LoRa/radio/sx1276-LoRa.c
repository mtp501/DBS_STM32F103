...
// Default settings
/*******************************************************************************
RFFrequency：    工作频率，可设范围169000000 ~ 525000000
Power：          发射功率，功率设置越大传输的距离越远，但功耗越高，最大设置20db。注意：LR35最大能到30db，是因为外部加了PA，放大了10db，但软件参数最大设置还是20db
SignalBw：       带宽，带宽设置越小能量越集中，传输距离越远，但速度也越慢
SpreadingFactor：扩频因子，扩频因子越大抗干扰能力越强，传输距离越远，但速度也越慢，当扩频因子设置为11和12时要开启低速率优化，即 SX1276LoRaSetLowDatarateOptimize( true )
ErrorCoding：    纠错码，纠错码越大抗干扰能力越强，但速度也会减慢
CrcOn：          CRC校验，默认打开即可，ON
ImplicitHeaderOn：隐式包头，默认关闭，OFF
RxSingleOn：     单次接收，默认循环接收，Continuous
FreqHopOn：      跳频开关，需要跳频时使用，默认关闭，OFF
HopPeriod：      跳频周期，需要跳频时使用，默认关闭，OFF
TxPacketTimeout：发送超时时间，根据传输速度调整
RxPacketTimeout：接收超时时间，根据传输速度调整
PayloadLength：  发送数据长度，隐式包头开启有效，范围1~255

推荐参数：（以下配置参数仅供参考，取值于看空旷距离,最大128字节）
0~500米  速率:21875bps     ：   Power：20，SignalBw：500kHz，SpreadingFactor：7，ErrorCoding：1，TxPacketTimeout：100，RxPacketTimeout：200
1500米： 速率:3125bps      ：   Power：20，SignalBw：125kHz，SpreadingFactor：8，ErrorCoding：1，TxPacketTimeout：500，RxPacketTimeout：1000
2500米： 速率:488bps       ：   Power：20，SignalBw：62.5kHz，SpreadingFactor：10，ErrorCoding：2，TxPacketTimeout：3000，RxPacketTimeout：4500
*******************************************************************************/
tLoRaSettings LoRaSettings =
{
